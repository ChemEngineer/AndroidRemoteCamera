...
using AndroidRemoteCamera.Listeners;
using Java.IO;
using Java.Lang;
using Java.Util;
...
{
    public class AndroidRemoteCameraFragment : Fragment, View.IOnClickListener, FragmentCompat.IOnRequestPermissionsResultCallback
    {
        ...
        private static readonly string TAG = "AndroidRemoteCameraFragment";
        ...
        private AndroidRemoteCameraSurfaceTextureListener mSurfaceTextureListener;
        ...
        public static AndroidRemoteCameraFragment NewInstance()
        {
            return new AndroidRemoteCameraFragment();
        }
        ...
        public override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            mSurfaceTextureListener = new AndroidRemoteCameraSurfaceTextureListener(this);
            ...
            db.path = System.IO.Path.Combine(Activity.GetExternalFilesDir(null).Path, "pic.jpg");
            db.server = new TcpImageServer(db.thisIp, db.serverPort, new Action(() => { TakePicture(); }));
            db.server.Start();
        }
        ...
        // Opens the camera specified by {@link AndroidRemoteCameraFragment#mCameraId}.
